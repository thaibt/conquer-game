...
public class RedCastle extends GamePiece {
	
	public RedCastle(int row, int col) {
		super (row, col, Player.LAVA, 50, 0, 0);
		name = "Lava Castle";
		crystal = 5;
	}
	public RedCastle (Position pos) {
		this (pos.r, pos.c);
	}
	...
	public void drawPiece(Graphics2D g2, int x, int y, int width, int height) throws IOException {
        ...
        final BufferedImage image = ImageIO.read(getClass().getResource("art/lavabase.png"));
